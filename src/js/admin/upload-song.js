    ...
    let controller = {
        ...
        initQiniu() {
            var uploader = Qiniu.uploader({
                ...
                uptoken_url: 'http://localhost:3000/uptoken', // Ajax 请求 uptoken 的 Url，**强烈建议设置**（服务端提供）
                ...
                domain: 'http://q7kyfjdks.bkt.clouddn.com', // bucket 域名，下载资源时用到，如：'http://xxx.bkt.clouddn.com/' **必需**
